...
export declare type GetModalContentStyleReturnType = {
    height: number;
    left: number;
    top: number;
    transform: string;
...
export declare type GetModalOverlayStyleReturnType = {
...
export declare type GetBoundingClientRectReturnType = {
    height: number;
    left: number;
    top: number;
    width: number;
